...
ExecStep xelab -m64 --debug typical --relax -L work -L secureip --snapshot tb_top_lvl_func_synth --prj C:/Users/nikolaos.marinos/xil_IP_projects/axi_pulser_receiver_v4/axi_pulser_receiver_v4.sim/sim_1/synth/func/tb_top_lvl.prj   work.tb_top_lvl
